...
oled_ext = Oled(OledData(image={0:OledReactionType.LAYER,1:["layer1.bmp","layer2.bmp","layer3.bmp","layer3.bmp"]}),toDisplay=OledDisplayMode.IMG,flip=False)
...
keyboard.keymap = [
    [
     ...
     KC.UP,    KC.PGUP,  KC.CAPS,   KC.A,     KC.S,     KC.D,     KC.F,     KC.G,     KC.H,     KC.J,     KC.K,      KC.L,     KC.SCLN,  KC.QUOT,    KC.BSLS,    KC.MPLY,   KC.MSTP,
     KC.HOME,  KC.RIGHT, KC.END,    KC.LSHIFT,KC.Z,     KC.X,     KC.C,     KC.V,     KC.B,     KC.N,     KC.M,      KC.COMMA, KC.DOT,   KC.SLASH,   KC.RSHIFT,  KC.ENT,    KC.LGUI,
     ...
     KC.TG(2), KC.NUBS,  KC.TAB,    KC.Q,     KC.W,     KC.E,     KC.R,     KC.T,     KC.Y,     KC.U,     KC.I,      KC.O,     KC.P,     KC.LBRC,    KC.RBRC,    KC.BSLS,   KC.PSCR,
     KC.UP,    KC.PGUP,  KC.CAPS,   KC.A,     KC.S,     KC.D,     KC.F,     KC.G,     KC.H,     KC.J,     KC.K,      KC.L,     KC.SCLN,  KC.QUOT,    KC.BSLS,    KC.MPLY,   KC.MSTP,
     KC.HOME,  KC.MNXT,  KC.END,    KC.LSHIFT,KC.Z,     KC.X,     KC.C,     KC.V,     KC.B,     KC.N,     KC.M,      KC.COMMA, KC.DOT,   KC.SLASH,   KC.RSHIFT,  KC.ENT,    KC.LGUI,
     ...
     KC.UP,    KC.PGUP,  KC.CAPS,   KC.A,     KC.S,     KC.D,     KC.F,     KC.G,     KC.H,     KC.P4,    KC.P5,     KC.P6,    KC.SCLN,  KC.QUOT,    KC.BSLS,    KC.MPLY,   KC.MSTP,
     KC.HOME,  KC.RIGHT, KC.END,    KC.LSHIFT,KC.Z,     KC.X,     KC.C,     KC.V,     KC.B,     KC.N,     KC.P1,     KC.P2,    KC.P3,    KC.SLASH,   KC.RSHIFT,  KC.ENT,    KC.LGUI,
     KC.LEFT,  KC.DOWN,  KC.PGDN,   KC.NO,    KC.LCTRL, KC.LALT,  KC.NO,    KC.NO,    KC.NO,    KC.SPACE, KC.MPLY,   KC.NO,    KC.NO,    KC.NO,      KC.RALT,    KC.RCTRL,  KC.NO
     ],
     [
     KC.ESC,   KC.TG(3), KC.F1,     KC.F2,    KC.F3,    KC.F4,    KC.F5,    KC.F6,    KC.F7,    KC.F8,    KC.F9,     KC.F10,   KC.F11,   KC.F12,     KC.TRNS,    KC.TRNS,   KC.TRNS,    
     KC.ESC,   KC.TG(1), KC.GRAVE,  KC.N1,    KC.N2,    KC.N3,    KC.N4,    KC.N5,    KC.N6,    KC.N7,    KC.N8,     KC.P0,    KC.N0,    KC.MINUS,   KC.EQUAL,   KC.BSPACE, KC.DEL,
     KC.TG(2), KC.NUBS,  KC.TAB,    KC.Q,     KC.W,     KC.E,     KC.R,     KC.T,     KC.Y,     KC.P1,    KC.P2,     KC.P3,    KC.P,     KC.LBRC,    KC.RBRC,    KC.BSLS,   KC.PSCR,
     KC.UP,    KC.PGUP,  KC.CAPS,   KC.A,     KC.S,     KC.D,     KC.F,     KC.G,     KC.H,     KC.P4,    KC.P5,     KC.P6,    KC.SCLN,  KC.QUOT,    KC.BSLS,    KC.MPLY,   KC.MSTP,
     KC.HOME,  KC.RIGHT, KC.END,    KC.LSHIFT,KC.Z,     KC.X,     KC.C,     KC.V,     KC.B,     KC.P7,    KC.P8,     KC.P9,    KC.DOT,   KC.SLASH,   KC.RSHIFT,  KC.ENT,    KC.LGUI,
     KC.LEFT,  KC.DOWN,  KC.PGDN,   KC.NO,    KC.LCTRL, KC.LALT,  KC.NO,    KC.NO,    KC.NO,    KC.SPACE, KC.MPLY,   KC.NO,    KC.NO,    KC.NO,      KC.RALT,    KC.RCTRL,  KC.NO]
]
